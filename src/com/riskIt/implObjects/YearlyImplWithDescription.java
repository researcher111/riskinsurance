...
public class YearlyImplWithDescription implements CalcImplWithDescriptionInterface {
	
	private final String description;
	
	public YearlyImplWithDescription(String description){
